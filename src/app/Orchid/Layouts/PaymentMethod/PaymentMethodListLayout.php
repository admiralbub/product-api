    ...
    protected function columns(): iterable
    {
        return [
            ...
            TD::make('available', __('Status'))->sort()->width(80)
                ->render(function (PaymentMethod $pay_method) {
                    if ($pay_method->available == 1) {
            ...
            TD::make(__('Actions'))
                ...
                ->width('100px')
                ->render(fn (PaymentMethod $pay_method) => DropDown::make()
                    ->icon('bs.three-dots-vertical')
                    ->list([

                        Link::make(__('Edit'))
                            ->route('platform.pay_method.edit', $pay_method->id)
                            ->icon('bs.pencil'),
