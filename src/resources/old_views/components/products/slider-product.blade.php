<div class="swiper-slide card_product position-relative">
    ...
    <div class="card_product-managment" >
        <div class="card_product-managment_scale AddCompareList">
        ...
        <div class="card_product-managment_heart AddWislistList">
    ...
    @if($product->status->getStatusAvailableAttribute())
        <div class="card_product-button mt-3">
            <button type="button" class="btn btn-primary AddBasket"  data-id="{{$product->id}}"  data-packid="{{$product->packs->first()->id}}">
                {{__('Add to cart')}}
            </button>
        </div>
    @endif
